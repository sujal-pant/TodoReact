  ...
  return (
    ...
    <Navbar/> 
       <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]">
        <h1 className='font-bold text-center text-3xl'>iPlan - Manager of your todos at one place</h1>
         ...
         <div className="todos">
          {todos.length ===0 && <div className='m-5'>Currenty No Todos Available</div> }
          {todos.map(item=>{
